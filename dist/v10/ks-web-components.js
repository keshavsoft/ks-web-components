...
var r = [
	...
	let t = e, n = document.createElement("input"), r = document.createElement("datalist"), a = "datalist-" + Math.random().toString(36).substr(2, 9);
	return n.setAttribute("list", a), r.id = a, t.listData && Array.isArray(t.listData) && t.listData.forEach((e) => {
		let t = document.createElement("option");
		typeof e == "object" && e ? (t.value = e.value, t.label = e.text, t.textContent = e.text) : t.value = e, r.appendChild(t);
	}), i(n, t), n.__dataListElement = r, n;
}, l = (e) => {
	...
	u.log(t, "----------");
	let n;
	return t.controlType === "datalist" ? n = c(t) : t.controlType === "select" ? n = l(t) : (n = document.createElement("input"), i(n, t)), a(n, t), o(n, t), s(n, t), n;
}, f = {
	...
	e.className = f[t.theme && f[t.theme] ? t.theme : "default"], t.className && (e.className = `${e.className} ${t.className}`);
}, h = (e) => {
	...
	m(r, n), h(r), e.appendChild(r), r.__dataListElement && e.appendChild(r.__dataListElement);
}, _ = (e, r, i) => {
	if (i?.showInput) {
		if (g(e, i), i?.showButton) {
			let t = document.createElement("button");
			t.textContent = i.buttonText || "Submit", t.className = p[i.theme && p[i.theme] ? i.theme : "default"], i.buttonClassName && (t.className = `${t.className} ${i.buttonClassName}`), e.appendChild(t);
		}
		return;
	}
	if (Array.isArray(r)) {
...
customElements.get("ks-table-cell-content-common") || customElements.define("ks-table-cell-content-common", v), window.ks = window.ks || {}, window.ks.webComponents = window.ks.webComponents || {}, Object.assign(v, window.ks.webComponents.KsTableCellContent || {}), window.ks.webComponents.KsTableCellContent = v;
//#endregion
