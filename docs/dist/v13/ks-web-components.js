...
var s = [
	...
	t.controlType === "button" && t.onClick !== void 0 && e.addEventListener("click", t.onClick), t.onChange !== void 0 && e.addEventListener("change", t.onChange), t.onInput !== void 0 && e.addEventListener("input", t.onInput);
}, p = (e) => {
	...
	let t = e, n;
	return t.controlType === "datalist" ? n = p(t) : t.controlType === "select" ? n = m(t) : (n = document.createElement("input"), c(n, t)), l(n, t), u(n, t), d(n, t), f(n, t), n;
}, g = (e) => {
	...
	a(r, n), g(r), e.appendChild(r), r.__dataListElement && e.appendChild(r.__dataListElement);
}, v = (e) => {
	let t = document.createElement("button");
	return t.textContent = e.buttonText || "Submit", t;
}, y = (e, t) => {
	e.className = r[t.theme && r[t.theme] ? t.theme : "default"], t.buttonClassName && (e.className = `${e.className} ${t.buttonClassName}`);
}, b = (e, t) => {
	t.buttonId && (e.id = t.buttonId), t.disabled && (e.disabled = !0), t.buttonTitle && (e.title = t.buttonTitle);
}, x = (e, t) => {
	let n = (n) => (r) => {
		t.preventDefault && r.preventDefault(), t.stopPropagation && r.stopPropagation();
		try {
			t[n](r, e);
		} catch (e) {
			console.error(`Error executing ${n} for button:`, e);
		}
	};
	typeof t.onClick == "function" && e.addEventListener("click", n("onClick")), typeof t.onFocus == "function" && e.addEventListener("focus", n("onFocus")), typeof t.onBlur == "function" && e.addEventListener("blur", n("onBlur")), typeof t.onMouseEnter == "function" && e.addEventListener("mouseenter", n("onMouseEnter")), typeof t.onMouseLeave == "function" && e.addEventListener("mouseleave", n("onMouseLeave"));
}, S = (e, t) => {
	let n = v(t);
	y(n, t), b(n, t), x(n, t), e.appendChild(n);
}, C = (e, n, r) => {
	let i = !1;
	if (r?.showInput && (_(e, r), i = !0), r?.showButton && (S(e, r), i = !0), !i) {
		if (Array.isArray(n)) {
			t(e, n);
			return;
		}
...
customElements.get("ks-table-cell-content-common") || customElements.define("ks-table-cell-content-common", w), window.ks = window.ks || {}, window.ks.webComponents = window.ks.webComponents || {}, Object.assign(w, window.ks.webComponents.KsTableCellContent || {}), window.ks.webComponents.KsTableCellContent = w, window.ks.webComponents.KsTableCellContent.version = "v11";
//#endregion
export { w as KsTableCellContent };
